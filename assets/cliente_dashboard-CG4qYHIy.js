import{o as e,t}from"./auth-Clpj9KIu.js";import{n}from"./icons-BIAwcOnk.js";import{t as r}from"./layout-BNuM0BnG.js";import{i}from"./livros-aH729Wwr.js";var a=1,o=12,s=1,c=null;async function l(){try{let{session:e,profile:n}=await t();if(!e||!n){window.location.href=`/login.html`;return}if(c=n,c.role===`proprietario`){window.location.href=`/pages/dashboard.html`;return}console.log(`Acesso autorizado ao catálogo: `,c.nome),await u()}catch(e){console.error(`Erro crítico na inicialização do cliente:`,e),window.location.href=`/login.html`}}async function u(){try{let{data:e,count:t}=await i(a,o);s=Math.ceil(t/o),d(e,t)}catch(t){console.error(`Erro ao carregar catálogo de livros:`,t),e(`Erro`,`Não foi possível carregar o acervo de livros.`,`error`)}}function d(e,t){r(`
    <div class="mb-8">
