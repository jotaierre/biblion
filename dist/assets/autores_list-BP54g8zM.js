import{o as e,s as t,t as n}from"./auth-XPfV9UYX.js";import{t as r}from"./icons-1bdniJDT.js";import{t as i}from"./layout-HDTcLn4t.js";import{a,i as o}from"./autores-CZ4NqgCn.js";var s=1,c=10,l=1,u=null;async function d(){try{let{data:e,count:t}=await o(s,c);l=Math.ceil(t/c),f(e,t)}catch(t){e(`Erro`,`Não foi possível carregar os autores: `+t.message,`error`)}}function f(e,t){i(`
            ...
            `:e.map(e=>`
              <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                ...
                <td class="px-6 py-4 text-right space-x-2">
                  <a href="/pages/autores/form.html?id=${e.id}" class="text-primary hover:text-primary-hover inline-block" title="Editar">
                    ${r(`pencil`)}
                  </a>
